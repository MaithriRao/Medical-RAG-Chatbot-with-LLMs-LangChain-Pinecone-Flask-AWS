⚕️ RAG Medical Chatbot: CI/CD on AWS

This repository features a Retrieval-Augmented Generation (RAG) Medical Chatbot deployed via a fully automated, containerized CI/CD pipeline on AWS.
...
| **DevOps** | **GitHub Actions, Docker** | Automates the full CI/CD pipeline and ensures application portability. |